        ...
        <div className="mt-12 pt-8 border-t border-gray-50">
          <div className="flex flex-wrap items-center justify-between">
            <div className="flex space-x-6 mb-4 md:mb-0">
              <button className="text-sm cursor-pointer text-gray-600 hover:text-gray-900 underline">Privacy policy</button>
              <button className="text-sm cursor-pointer text-gray-600 hover:text-gray-900 underline">Terms and conditions</button>
              <button className="text-sm cursor-pointer text-gray-600 hover:text-gray-900 underline">Accessibility</button>
            </div>
          </div>
