...
//         {[1, 2, 3, 4].map((i) => (
//           <div key={i} className="relative w-full aspect-[3/4] bg-gray-200 animate-pulse rounded" />
//         ))}
//       </div>
...
//     const imageUrl =
//       img.formats?.large?.url && img.formats.large.url.startsWith("http")
//         ? img.formats.large.url
//         : `${process.env.NEXT_PUBLIC_STRAPI_MEDIA_URL}${img.formats?.large?.url || img.url}`
...
//                       <Image
//                         src={
//                           colorImage.url.startsWith("http") ? colorImage.url : `${process.env.NEXT_PUBLIC_STRAPI_MEDIA_URL}${colorImage.url}`
//                         }
...
// Cache the product query function similar to Payload's pattern
