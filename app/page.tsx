...
//   const [homeData, products] = await Promise.all([getHomeData(), getProducts()])

//   return (
//     <div className="min-h-screen bg-white">
//       <MainPageClient homeData={homeData} products={products} />
//     </div>
//   )
// }
...
// // Cache functions similar to Payload's pattern
...
//   // Fetch data in parallel similar to Payload's approach
//   const [homeData, products] = await Promise.all([queryHomeData(), queryProducts()])
...
// Add banner data fetching function
...
export default async function HomePage() {
  // Fetch data in parallel including banners
